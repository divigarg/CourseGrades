...
<body>
	...
	if($showSignupSuccess){
		...
		<strong>Success!</strong> Sign Up was successful. You can now login.
		<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
	  </div>';
	}

	if($showSignupfailure){
	...
	?>
		...
		<table class="hover" id="myTable">
			...
			<tbody>
				<?php
				$sql = "SELECT * FROM teaching_session";
          ...
          <td>" . $courseid . "</td>
          <td>" . $course_name . "</td>
          <td>" . $professor_firstname . " " . $professor_lastname . "</td>
          </tr>";
				}
				?>
			</tbody>
